...
// Hardcoded Table
const colorTablePrWin = {
  dark: {
    "--uxp-host-background-color": "#323232", // PPRO
    "--uxp-host-text-color": "#ffffff",
    "--uxp-host-border-color": "#454545",
    "--uxp-host-link-text-color": "#4b9cf5",
    "--uxp-host-widget-hover-background-color": "#5b5b5b",
  ...
  darkest: {
    "--uxp-host-background-color": "#1d1d1d", //PPRO
    "--uxp-host-text-color": "#ffffff",
    "--uxp-host-border-color": "#292929",
    "--uxp-host-link-text-color": "#4b9cf5",
    "--uxp-host-widget-hover-background-color": "#3d3d3d",
  ...
  light: {
    "--uxp-host-background-color": "#f8f8f8", // PPRO
    "--uxp-host-text-color": "#424242",
    "--uxp-host-border-color": "#9c9c9c",
    "--uxp-host-link-text-color": "#4b9cf5",
    "--uxp-host-widget-hover-background-color": "#9d9d9d",
...
export const getColorScheme = async () => {
  ...
  // Overrides
  if (platform === "darwin" && hostName.startsWith("premierepro")) {
    colors = colorTablePrMac[theme];
  } else if (platform.includes("win") && hostName.startsWith("premierepro")) {
    colors = colorTablePrWin[theme];
  }
  return { theme, colors };
};
