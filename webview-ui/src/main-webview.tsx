  ...
  return (
    <main>
      ...
      <div className="stack-colors">
        ...
        ></div>
        <div style={{ backgroundColor: "var(--uxp-host-text-color)" }}></div>
        <div style={{ backgroundColor: "var(--uxp-host-border-color)" }}></div>
        <div
          style={{ backgroundColor: "var(--uxp-host-link-text-color)" }}
        ></div>
        <div
          style={{
            backgroundColor: "var(--uxp-host-widget-hover-background-color)",
          }}
        ></div>
        <div
          style={{ backgroundColor: "var(--uxp-host-widget-hover-text-color)" }}
        ></div>
        <div
          style={{
        ...
        ></div>
        <div
          style={{ backgroundColor: "var(--uxp-host-text-color-secondary)" }}
        ></div>
        <div
          style={{ backgroundColor: "var(--uxp-host-link-hover-text-color)" }}
        ></div>
        <div
